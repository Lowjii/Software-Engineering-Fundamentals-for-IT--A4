...
public class AppTest {
    ...
    // Valid ID, should record in text file
    @Test
    ...
    // Test: ID length is too short, person should not be added and error message should be printed for reference
    @Test
    ...
    // Test: ID has no special characters, person should not be added and error message should be printed for reference
    @Test
    ...
    // Test: Address not in Victoria, person should not be added and error message should be printed for reference
    @Test
    ...
    // Test: DOB format is incorrect, person should not be added and error message should be printed for reference
    @Test
    ...
    // Tests for addPerson
    // Test: Person is under 18, cannot change address, person should not be added and error message should be printed for reference
    @Test
    ...
    // Test: Valid usage of addDemeritPoint, over 21 no suspension
    @Test
    ...
    // Test: Incorrect date format for offence date, points should not be added and error message should be printed for reference
    @Test
    ...
    // Test: Points allocated are out of range (1-6), points should not be added and error message should be printed for reference
    @Test
    ...
    // Test: Valid suspension of a driver aged over 21, should suspend after 12 demerit points are allocated
    @Test
    ...
    // Test: Valid suspension of a driver aged under 21, should suspend after 6 demerit points are allocated
    @Test
